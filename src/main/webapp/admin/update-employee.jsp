...
<head>
    <meta charset="UTF-8">
    <title>Update Employee - Payroll Management System</title>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="update-employee.jsp">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="form-container">
                    ...
                    <!-- Update Form -->
                    <form action="../UpdateEmployeeServlet" method="post" class="needs-validation" novalidate>
                        <div class="mb-3">
                ...
                .forEach(function (form) {
                    form.addEventListener('submit', function (event) {
                        if (!form.checkValidity()) {
                            ...
                            if (!confirm('Do you want to update this employee\'s details?')) {
                                event.preventDefault();
                            }
                        }
